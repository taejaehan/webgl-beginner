...
Camera.prototype.setRotateAngle = function(angle){
    // mat4.identity(this.matrix);
    // mat4.translate(this.matrix, this.position);
    // mat4.rotateX(this.matrix,angle*Math.PI/180);
    // mat4.rotateY(this.matrix,angle*Math.PI/180);
    // mat4.rotateZ(this.matrix,angle*Math.PI/180);
