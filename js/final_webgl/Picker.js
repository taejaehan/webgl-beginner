...
Picker.prototype._compare = function(readout, color){
    console.info('comparing Scene.objects '+Scene.objects.alias+' diffuse ('+Math.round(color[0]*255)+','+Math.round(color[1]*255)+','+Math.round(color[2]*255)+') == readout ('+ readout[0]+','+ readout[1]+','+ readout[2]+')');
